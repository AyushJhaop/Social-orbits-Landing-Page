    ...
    <div className="min-h-screen bg-white flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-7xl mx-auto py-8 sm:py-12 lg:py-16">
        ...
        <div className="flex justify-center items-center gap-3 sm:gap-4 mb-8 sm:mb-12 lg:mb-16">
          ...
          <a href="https://www.instagram.com/ta.ha_k/" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors duration-300 shadow-md hover:shadow-lg">
            <Instagram className="w-4 h-4 sm:w-5 sm:h-5" />
          </a>
          <a href="https://www.linkedin.com/in/taha-kushalgarh/" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors duration-300 shadow-md hover:shadow-lg">
            <Linkedin className="w-4 h-4 sm:w-5 sm:h-5" />
          </a>
          <a href="https://wa.me/916376262400" target="_blank" rel="noopener noreferrer" className="p-2 sm:p-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors duration-300 shadow-md hover:shadow-lg">
