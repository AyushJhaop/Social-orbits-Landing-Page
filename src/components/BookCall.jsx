        ...
        <div className="text-center">
          ...
          >
            ...
            <div className="flex space-x-2 md:space-x-3">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/ta.ha_k/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-7 h-7 md:w-8 md:h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition-colors cursor-pointer"
              >
              ...
              {/* LinkedIn */}
              <a 
                href="https://www.linkedin.com/in/taha-kushalgarh/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-7 h-7 md:w-8 md:h-8 bg-black rounded flex items-center justify-center hover:bg-gray-800 transition-colors cursor-pointer"
              >
          ...
          >
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Use the contact methods above to reach out and discuss your business goals with our team.
              </p>
            </div>
          </motion.div>
